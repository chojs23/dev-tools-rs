...
use crate::{
    ...
    ui::{
        ...
        panels::{
            ...
            error_display::ErrorDisplay, generators_panel::GeneratorsPanel, image_panel::ImagePanel,
...
impl App {
    ...
    fn display_central_panel(&mut self, ctx: &mut FrameCtx<'_>) {
        ...
        egui::CentralPanel::default()
            ...
            .show(ctx.egui, |ui| match ctx.app.central_panel_tab {
                ...
                CentralPanelTab::Image => self.image_panel_ui(ctx, ui),
            });
    }
    ...
    fn image_panel_ui(&mut self, ctx: &mut FrameCtx<'_>, ui: &mut egui::Ui) {
        self.error_display.render(ctx, ui);
        self.image_panel.display(ctx, ui);
    }
