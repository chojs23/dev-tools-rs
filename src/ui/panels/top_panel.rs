...
impl TopPanel {
    ...
    pub fn render_tab_buttons(&self, ctx: &mut FrameCtx<'_>, ui: &mut Ui) {
        ...
        add_button_if!(
            "Cryptography",
            matches!(ctx.app.central_panel_tab, CentralPanelTab::Cryptography),
            {
                ctx.app.central_panel_tab = CentralPanelTab::Cryptography;
                ctx.app.sidepanel.show = false;
            }
        );
        add_button_if!(
            "Ai",
            matches!(ctx.app.central_panel_tab, CentralPanelTab::Claude),
            {
                ctx.app.central_panel_tab = CentralPanelTab::Claude;
                ctx.app.sidepanel.show = false;
            }
        );
    }
