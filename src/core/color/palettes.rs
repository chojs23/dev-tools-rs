...
use super::palette::NamedPalette;
...
impl Palettes {
    pub const STORAGE_KEY: &'static str = "dev-tools-rs.saved.palettes";
...
#[cfg(test)]
mod tests {
    use crate::core::color::{palette::Palette, Color, Rgb};

    use super::*;
    const C1: Color = Color::Rgb(Rgb::new_unchecked(0., 0., 0.));
    const C2: Color = Color::Rgb(Rgb::new_unchecked(0., 1., 0.));
    const C3: Color = Color::Rgb(Rgb::new_unchecked(1., 0., 1.));
